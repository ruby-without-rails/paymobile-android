...
import br.com.frmichetti.carhollics.android.adapter.ServiceAdapter;
...
public class CardsMain extends AppCompatActivity {
    ...
    private void prepareAlbums() {
        ...
        s.setTitle("Servico 1");
        s.setPrice(new BigDecimal(10));
        s.setDescription("lalalalalalal");
        services.add(s);

        s = new Service();
        s.setTitle("Servico 2");
        s.setPrice(new BigDecimal(20));
        s.setDescription("lalalalalalal");
        services.add(s);

        s = new Service();
        s.setTitle("Servico 3");
        ...
        s = new Service();
        s.setTitle("Servico 4");
        s.setPrice(new BigDecimal(40));
        s.setDescription("lalalalalalal");
        services.add(s);
