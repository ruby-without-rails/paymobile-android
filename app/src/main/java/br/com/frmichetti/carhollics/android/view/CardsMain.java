...
import br.com.frmichetti.carhollics.android.adapter.ServicoAdapter;
...
public class CardsMain extends AppCompatActivity {
    ...
    private void prepareAlbums() {
        ...
        s.setNome("Servico 1");
        s.setPreco(new BigDecimal(10));
        s.setDescricao("lalalalalalal");
        servicos.add(s);

        s = new Servico();
        s.setNome("Servico 2");
        s.setPreco(new BigDecimal(20));
        s.setDescricao("lalalalalalal");
        servicos.add(s);

        s = new Servico();
        s.setNome("Servico 3");
        s.setPreco(new BigDecimal(30));
        s.setDescricao("lalalalalalal");
        servicos.add(s);
